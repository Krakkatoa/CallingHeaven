...
struct TheresePrayers {
    ...
    let factsArray = [
        ...
        "O Jesus, dear Holy Child, my only treasure, I abandon myself to Thy every whim. I seek no other joy than that of calling forth Thy sweet Smile. Vouchsafe to me the graces and the virtues of Thy Holy Childhood, so that on the day of my birth into Heaven the Angels and Saints may recognize in Thy Spouse: Teresa of the Child Jesus. Amen.",
