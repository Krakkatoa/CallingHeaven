...
struct TeresaPrayers {
    ...
    let factsArray = [
        ...
        "Teach me, my God, to suffer in peace the afflictions which You send me that my soul may emerge form the crucible like gold, both brighter and purer, to find You within me. Amen.",
